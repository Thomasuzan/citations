    ...
    <header id="header">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php?controller=authors">Citations</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="d-flex gap-3 list-unstyled my-auto">
                        <?php if (isset($_SESSION['profile'])): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?controller=profile&id=<?= $_SESSION['profile']['id'] ?>" title="Mon profil">
                                    <i class="bi bi-person-fill"></i>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?controller=authentification&action=deconnexion" title="Déconnexion">
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?controller=authentification" title="Se connecter">
